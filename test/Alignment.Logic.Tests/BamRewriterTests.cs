...
namespace Alignment.Logic.Tests
{
    public class BamRewriterTests
    {
        ...
        {
            //Assert.True(false, "looks like running this causes Alignment.Logic.Tests.dll to lock");

            //Severity Code    Description Project File Line    Suppression State
            //Error C:\Projects_tdunn\git\Pisces5_Ent\Pisces5\test\Alignment.Logic.Tests\error CS2012: Cannot open 'C:\Projects_tdunn\git\Pisces5_Ent\Pisces5\test\Alignment.Logic.Tests\bin\Debug\netcoreapp1.0\Alignment.Logic.Tests.dll' for writing-- 'The process cannot access the file 'C:\Projects_tdunn\git\Pisces5_Ent\Pisces5\test\Alignment.Logic.Tests\bin\Debug\netcoreapp1.0\Alignment.Logic.Tests.dll' because it is being used by another process.'   Alignment.Logic.Tests   C:\Program Files(x86)\MSBuild\Microsoft\VisualStudio\v14.0\DotNet\Microsoft.DotNet.Common.Targets  262
