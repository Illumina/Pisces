...
namespace Pisces.Tests.ApplicationOptionsTests
{
    ...
    {
        private string _existingBamPath = Path.Combine(TestPaths.LocalTestDataDirectory, "Chr17Chr19.bam");
        private string _existingBamPath2 = Path.Combine(TestPaths.LocalTestDataDirectory, "Chr17Chr19_removedSQlines.bam");
        private string _existingGenome = Path.Combine(TestPaths.SharedGenomesDirectory, "chr19");
        private string _existingInterval = Path.Combine(TestPaths.LocalTestDataDirectory, "chr17only.picard");
        ...
        public void Validate()
        {
            ...
            // verify log folder
            // ---------------------
            Assert.Equal(Path.Combine(TestPaths.LocalTestDataDirectory, "PiscesLogs"), option.LogFolder);
            ...
            ExecuteValidationTest((o) => { o.VariantCallingParameters.MaximumVariantQScore = 0;
         ...
         ExecuteValidationTest((o) => { o.VariantCallingParameters.LowGenotypeQualityFilter = 101; }, true);
            ...
            //Priors path
            ExecuteValidationTest((o) => { o.PriorsPath = Path.Combine(TestPaths.LocalTestDataDirectory, "small_s1.bam"); }, true);
        ...
        public void PrintAndSaveApplicationLegacyOptions()
        {
            ...
            var applicationOptionsFile = Path.Combine(TestPaths.LocalTestDataDirectory, "SomaticVariantCallerOptions.used.json");
