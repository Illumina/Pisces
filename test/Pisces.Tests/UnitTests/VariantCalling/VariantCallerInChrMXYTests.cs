...
namespace Pisces.Tests.UnitTests.VariantCalling
{
	public class VariantCallerInChrMXYTests
	{
		...
		{
			var genotypeCaculator = GenotypeCreator.CreateGenotypeCalculator(PloidyModel.Diploid, 0.05f, 30, null, 0, 100, 0.02f, "chrM");
		...
		public void ChrXFemaleGenotypeCalculatorTests()
		{
			...
			var genotypeCaculator = GenotypeCreator.CreateGenotypeCalculator(PloidyModel.Diploid, 0.05f, 30, diploidPars, 0, 100, 0.02f, "chrX",false);
		...
		{
			var diploidPars = new DiploidThresholdingParameters(new float[] { 0.2f, 0.7f, 0.8f });
			var genotypeCaculator = GenotypeCreator.CreateGenotypeCalculator(PloidyModel.Diploid, 0.05f, 30, diploidPars, 0, 100, 0.02f, "chrX", true);
		...
		{
			var diploidPars = new DiploidThresholdingParameters(new float[] { 0.2f, 0.7f, 0.8f });
			var genotypeCaculator = GenotypeCreator.CreateGenotypeCalculator(PloidyModel.Diploid, 0.05f, 30, diploidPars, 0, 100, 0.02f, "chrX");
		...
		{
			var diploidPars = new DiploidThresholdingParameters(new float[] { 0.2f, 0.7f, 0.8f });
			var genotypeCaculator = GenotypeCreator.CreateGenotypeCalculator(PloidyModel.Diploid, 0.05f, 30, diploidPars, 0, 100, 0.02f, "chrY");
		...
		{
			var diploidPars = new DiploidThresholdingParameters(new float[] { 0.2f, 0.7f, 0.8f });
			var genotypeCaculator = GenotypeCreator.CreateGenotypeCalculator(PloidyModel.Diploid, 0.05f, 30, diploidPars, 0, 100, 0.02f, "chrY",true);
