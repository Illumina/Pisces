...
namespace Pisces.Tests.UnitTests
{
    ...
    {
        static string GenomeChr19 = Path.Combine(UnitTestPaths.TestGenomesDirectory, "chr19");
        static string OutputFolder = Path.Combine(UnitTestPaths.TestDataDirectory, "ExcelStitchingTests");
        ...
        public static IEnumerable<object[]> ScenarioData
        {
            get
            {
                const string inputDirectory = @"SharedTestData";
                ...
                using (StreamWriter sw = new StreamWriter(loadingResultsSummary, true))
                {
                ...
                using (StreamWriter sw1 = new StreamWriter(biasResultsSummary, true))
                {
        ...
        public static ApplicationOptions Options
        {
            get
            {
                return (new ApplicationOptions()
                {
                    ...
                    OutputFolder = Path.Combine(UnitTestPaths.TestDataDirectory, "ExcelStitchingTests"),
