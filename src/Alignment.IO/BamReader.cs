	...
	public class BamReader : BgzfCommon, IBamReader
	{
		...
		public bool GetNextAlignment(ref BamAlignment alignment, bool skipAdditionalParsing)
		{
			...
			if (!skipAdditionalParsing)
			{
				...
				{
                    // NOTE: Consumers of these objects expect all uppercase letters, even though the SAM/BAM
                    // spec allows mixed case. 
        ...
        private bool Jump(int refID, int position, bool forwardOnly)
		{
            ...
            if (bamIterator.CurrentOffset < currentPosition && forwardOnly)
                bamIterator.CurrentOffset = currentPosition;
