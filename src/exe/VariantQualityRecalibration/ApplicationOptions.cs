...
namespace VariantQualityRecalibration
{
    public class ApplicationOptions
    {
        ...
        public static void PrintUsageInfo()
        {
            ...
            Console.WriteLine("-genome.vcf input file name ");
            Console.WriteLine("Optional arguments:");
            Console.WriteLine("-locicount When using a vcf instead of a genome.vcf, the user should input the estimated num loci.");
            ...
            while (argumentIndex < Arguments.Length)
            {
                ...
                switch (Arguments[argumentIndex].ToLower())
                {
                    ...
                    case "-out":
                        ...
                        break;
                    case "-locicount":
                        options.LociCount = int.Parse(value);
                        break;
                    case "-b":
