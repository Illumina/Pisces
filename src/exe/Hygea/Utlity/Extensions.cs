...
//            //var startIndexInReference = read.GetAdjustedPositionFromLeft(true);
...
//            summary.HasHighFrequencyIndel = false;
//            summary.MismatchesIncludeSoftclip = new List<string> { };

//            var startIndexInRead = 0;
//            var startIndexInReferenceAdjusted = startIndexInReference - (int)cigarData.GetPrefixClip();
...
//                                if (startIndexInReferenceAdjusted + i < 0 || startIndexInReferenceAdjusted + i >= refSequence.Length)
//                                {
//                                    summary.NumMismatchesIncludeSoftclip++;
//                                }
//                                else if (readSequence[startIndexInRead + i] != refSequence[startIndexInReferenceAdjusted + i])
//                                {
//                                    summary.NumMismatchesIncludeSoftclip++;
//                                    var mismatch = string.Format("{0}_{1}_{2}", startIndexInReferenceAdjusted + i, refSequence[startIndexInReferenceAdjusted + i], readSequence[startIndexInRead + i]);
...
//                                hasHitNonMatch = true;
//                                endAnchorLength = 0;
//                                var mismatch = string.Format("{0}_{1}_{2}", startIndexInReference + i, refSequence[startIndexInReference + i], readSequence[startIndexInRead + i]);
//                                summary.MismatchesIncludeSoftclip.Add(mismatch);
//                            }
//                            else
//                            {
...
//                    startIndexInReferenceAdjusted += (int)operation.Length;

//                }
//                if (operation.Type == 'S') { startIndexInReferenceAdjusted += (int)operation.Length; }
