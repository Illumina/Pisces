...
{
	public class HaploidGenotyeCalculator:IGenotypeCalculator
	{

		private PloidyModel _ploidyModel = PloidyModel.Diploid; //NOTE: we still use the parameters for diploid mode
		...
		public HaploidGenotyeCalculator(int minCalledVariantDepth, int minGQscore, int maxGQscore,float minorVF=0.70f,float majorVF = 0.70f)
		{
