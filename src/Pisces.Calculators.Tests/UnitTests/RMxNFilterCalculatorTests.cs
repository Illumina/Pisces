...
namespace Pisces.Logic.Calculators.Tests
{
    public class RMxNFilterCalculatorTests
    {
        ...
        {
            Assert.True(RMxNCalculator.CompareSubstring("ABC", "ABC", 0));
            Assert.True(RMxNCalculator.CompareSubstring("C", "ABC", 2));
            Assert.False(RMxNCalculator.CompareSubstring("ABD", "ABC", 0));
            Assert.False(RMxNCalculator.CompareSubstring("ABD", "ABC", 2));
        }
