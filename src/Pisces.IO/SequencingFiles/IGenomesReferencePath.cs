...
namespace SequencingFiles
{
    ...
    public class IGenomesReferencePath
    {
        ...
        public static IGenomesReferencePath GetReference(GenomeMetadata genome)
        {
            return GetReference(genome.Sequences[0]);
        }

        public static IGenomesReferencePath GetReference(GenomeMetadata.SequenceMetadata sequence)
        {
