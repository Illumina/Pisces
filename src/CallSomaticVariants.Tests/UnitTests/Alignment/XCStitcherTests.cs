...
namespace CallSomaticVariants.Tests.UnitTests.Alignment
{
    public class XCStitcherTests
    {
        ...
        public void TryStitch_ConsensusSequence()
        {
            ...
            var read1 = TestHelper.CreateRead("chr1", "TTTTTTTT", 12341, new CigarAlignment("1M2I5M"), qualityForAll: (byte)r1qualities);
            read1.StitchedCigar = new CigarAlignment("1M2I5M1I2M");

            var read2 = TestHelper.CreateRead("chr1", "AAAAAAAA", 12342, new CigarAlignment("5M1I2M"), qualityForAll: (byte)r2qualities);
