...
namespace CallSomaticVariants.Tests.UnitTests
{
    public class FactoryTests
    {
        ...
        private readonly string _intervalsInvalid = Path.Combine(UnitTestPaths.TestDataDirectory,
        ...
        {
            var factory = new Factory(new ApplicationOptions()
            {
        ...
        public void GetGenome_OneDefault()
        {
            ...
            // -----------------------------------------------
            factory = new Factory(new ApplicationOptions()
            {
                BAMPaths = new[] {_bamChr19, _bamChr17Chr19, _bamChr17Chr19Dup},
        ...
        public void GvcfHeaderFormat()
        {
            ...
            TestHelper.VcfFileFormatValidation(outputFile, 5);
        }
