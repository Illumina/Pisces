...
namespace Pisces.Domain.Models
{
    public class CigarDirection
    {
        ...
        public override string ToString()
        {
            ...
            {
                return $"{Directions[0].Length}{DirectionHelper.GetDirectionKey(Directions[0].Direction)}";
            }
            if (Directions.Count == 2)
            {
                return $"{Directions[0].Length}{DirectionHelper.GetDirectionKey(Directions[0].Direction)}{Directions[1].Length}{DirectionHelper.GetDirectionKey(Directions[1].Direction)}";
            }
            if (Directions.Count == 3)
            {
                return $"{Directions[0].Length}{DirectionHelper.GetDirectionKey(Directions[0].Direction)}{Directions[1].Length}{DirectionHelper.GetDirectionKey(Directions[1].Direction)}{Directions[2].Length}{DirectionHelper.GetDirectionKey(Directions[2].Direction)}";
            }
