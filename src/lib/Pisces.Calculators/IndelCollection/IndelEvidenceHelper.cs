    ...
    public static class IndelEvidenceHelper
    {
            ...
            bool isReputable, string chrom, int minMapQuality, bool stitched = false)
        {
                ...
                bamAlignment.IsPrimaryAlignment())
            {
                ...
                //var names = new List<string>() {"HWI-ST807:461:C2P0JACXX:6:1109:16772:5896", "HWI-ST807:461:C2P0JACXX:6:1101:17695:100774", "HWI-ST807:461:C2P0JACXX:6:2202:12232:18465", "HWI-ST807:461:C2P0JACXX:6:1309:12725:66973" };
                //if (names.Contains(bamAlignment.Name))
                //{
                //    Console.WriteLine($"Found {indels.Count} in {bamAlignment.Name}");
                //}
                if (indels.Any())
                {
