...
namespace Pisces.Calculators
{
    public class CoverageCalculator : ICoverageCalculator
    {
        ...
        /// </summary>
        protected virtual void CalculateSpanning(CalledAllele variant, IAlleleSource alleleCountSource, int startPointPosition, int endPointPosition, bool anchored = true)
        {
