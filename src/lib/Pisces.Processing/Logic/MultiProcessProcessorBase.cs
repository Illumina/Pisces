...
//        private readonly string _piscesPath;
...
//            string[] commandLineArgs, string outputFolder, string logFolder, string dotnetPath = null, string piscesPath = null)
//        {
//            Genome = genome;
...
//            _piscesPath = piscesPath ?? System.Reflection.Assembly.GetEntryAssembly().Location;
...
//                        {
//                            ExecutablePath = "cmd", //may need to be replaced with full install path
//                            CommandLineArguments = "dotnet " + _piscesPath + " " + GetCommandLineArgs(chrName, inputFile)
