...
namespace Gemini.Utility
{
    public class RealignmentOptions
    {
        ...
        public List<PairClassification> CategoriesForRealignment = new List<PairClassification>{
            PairClassification.ImperfectStitched, PairClassification.FailStitch, PairClassification.UnstitchIndel,
