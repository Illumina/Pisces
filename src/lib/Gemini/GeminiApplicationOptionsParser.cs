...
namespace Gemini
{
    ...
    public class GeminiApplicationOptionsParser : BaseOptionParser
    {
        ...
        public override Dictionary<string, OptionSet> GetParsingMethods()
        {
            ...
            var subprocessOnly = new OptionSet
            {
                ...
                {"SortPerChrom=", OptionTypes.BOOL + $" Whether to sort the per-chromosome bams, for debugging. Default: false.",  o=>  ProgramOptions.GeminiOptions.SortPerChrom = bool.Parse(o) },
            ...
            var realignBinOptions = new OptionSet()
            {
                ...
                {"MessySiteThreshold=", OptionTypes.INT + $" Minimum (raw) number of messy-type reads that must be present in a neighborhood for it to be considered messy and a potential realignable neighborhood. Must also meet the frequency thresholds, if using CollectDepth=true. Default: 1.",  o=>  ProgramOptions.GeminiOptions.MessySiteThreshold = int.Parse(o) },
            ...
            var optionDict = new Dictionary<string, OptionSet>
            {
                ...
                {"GEMINI_SUBPROCESS", subprocessOnly},
