    ...
    public class ExtensionsTests
    {
        ...
        private static void CheckRMxN(string filter, int expectedM, int expectedN, bool expectedIsRMxN)
       {
        ...
        public void MapGT()
        {
			...
			Assert.Equal(Genotype.HemizygousAlt, Extensions.MapGTString("1", 1));
			Assert.Equal(Genotype.HemizygousRef, Extensions.MapGTString("0", 1));
			Assert.Equal(Genotype.HemizygousNoCall, Extensions.MapGTString(".", 1));
        ...
        {
            Assert.True(Extensions.CompareSubstring("ABC", "ABC", 0));
            Assert.True(Extensions.CompareSubstring("C", "ABC", 2));
            Assert.False(Extensions.CompareSubstring("ABD", "ABC", 0));
            Assert.False(Extensions.CompareSubstring("ABD", "ABC", 2));
        }
