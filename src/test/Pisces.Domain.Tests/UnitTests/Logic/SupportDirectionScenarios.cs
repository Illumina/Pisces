...
namespace Pisces.Domain.Tests.UnitTests.Logic
{
    public interface ISupportDirectionTestSetup<T,U,V>
    {
        ...
        T GetDeletionDirectionForStitchedRead(V variant, U alignment, int deletionLength);
    }
    ...
    public class PiscesSupportDirectionTestSetup :  ISupportDirectionTestSetup<DirectionType,Read,CandidateAllele>
    {
        ...
        public static CigarDirection GetCigarDirection(int numForward, int numStitched, int numReverse)
        {
            var directionString = numForward + "F" + numStitched + "S" + numReverse + "R";            
            return new CigarDirection(directionString);
        }
    ...
    public class SupportDirectionSuite<T, U, V>
    {
        ...
        public void RunDeletionScenarios(V variant, int deletionLength)
        {
            ...
            //update 5.2.5: lets make this be stitched. deletion is all inside stitched region, so it seems fair.
            // 0 0 0 2 2 2 2 1 1 1     CoverageDirection
            // N N N D D D N N N N     Variant Position
            // 0 1 2 - - - 3 4 5 6     Index In Read
            supportDirectionScenarios.VariantStartsAtFirstPositionOfStitchedRegion_EndsWithinStitchedRegion(variant, Stitched, deletionLength);
            ...
            // N N N D D D N N N N     Variant Position
            // 0 1 2 - - - 3 4 5 6     Index In Read
            supportDirectionScenarios.VariantStartsAtFirstPositionOfStitchedRegion_EndsOnEdgeOfStitchedRegion(variant, Stitched, deletionLength);

            //Variant starts at first position of stitched region and ends after end of stitched region - should be forward in current
            //update 5.2.5: Should this be reverse? deletion starts inside stitched region, and passes into reverse section
            // 0 0 0 2 2 1 1 1 1 1     CoverageDirection
            // N N N D D D N N N N     Variant Position
            // 0 1 2 - - - 3 4 5 6     Index In Read
            supportDirectionScenarios.VariantStartsAtFirstPositionOfStitchedRegion_EndsAfterEndOfStitchedRegion(variant, Reverse, deletionLength);
            ...
            // N N N D D D N N N N     Variant Position
            // 0 1 2 - - - 3 4 5 6     Index In Read
            supportDirectionScenarios.VariantStartsWithinStitchedRegion_EndsOnEdgeOfStitchedRegion(variant, Stitched, deletionLength);
    ...
    public class SupportDirectionScenarios<T,U,V>
    {
        ...
        public void VariantStartsAtFirstPositionOfStitchedRegion_EndsWithinStitchedRegion(V variant, T expectedDirection, int deletionLength = 0)
        {
            ...
            if (deletionLength > 0)
                Assert.Equal(expectedDirection, TestSetup.GetDeletionDirectionForStitchedRead(variant, alignment, deletionLength));
        }
        ...
        public void VariantStartsWithinStitchedRegion_EndsOnEdgeOfStitchedRegion(V variant, T expectedDirection,
