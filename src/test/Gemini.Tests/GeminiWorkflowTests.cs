...
namespace Gemini.Tests
{
    public class GeminiWorkflowTests
    {
        ...
        public void Execute_VerifySkipRealign()
        {
            ...
            mockRealigner.Verify(x => x.RealignAroundCandidateIndels(It.IsAny<Dictionary<string, int[]>>(), It.IsAny<Dictionary<string, Dictionary<PairClassification, List<string>>>>()), Times.Never);
        ...
        public void Execute_VerifyMergeAndFinalize()
        {
            ...
            mockGeminiFactory.Verify(x => x.GetCategorizationAndEvidenceSource(), Times.Once);
            mockRealigner.Verify(x => x.RealignAroundCandidateIndels(It.IsAny<Dictionary<string, int[]>>(), It.IsAny<Dictionary<string, Dictionary<PairClassification, List<string>>>>()), Times.Once);
