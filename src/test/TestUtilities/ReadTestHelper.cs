...
namespace TestUtilities
{
    ...
    {
        public static Tuple<Read, Read> CreateReadPair(string nameBase, int sequencelength, ReadCollapsedType type,
        ...
        public static Read CreateRead(string chr, string sequence, int position,
            CigarAlignment cigar = null, byte[] qualities = null, int matePosition = 0, byte qualityForAll = 30, bool isReverseMapped = false)
        {
