...
namespace Pisces.Tests.UnitTests.Models
{
    public class GenomeTests
    {
        ...
        {
            var genomeDirectory = Path.Combine(TestPaths.SharedGenomesDirectory, "chr17chr19");
        ...
        public void Error()
        {
            var genomeDirectoryBadGenomeSizeFormat = Path.Combine(TestPaths.SharedGenomesDirectory, "invalidGenomeSize");
            var genomeDirectoryNoGenomeSize = Path.Combine(TestPaths.SharedGenomesDirectory, "noGenomeSize");
            var genomeDirectoryFaNotExists = Path.Combine(TestPaths.SharedGenomesDirectory, "invalidGenome");
            var genomeDirectoryFaiNotExists = Path.Combine(TestPaths.SharedGenomesDirectory, "invalidGenome_noFai");
