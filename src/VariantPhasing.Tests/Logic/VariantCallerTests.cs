    ...
    public class VariantCallerTests
    {
        ...
        public void VarCallsBecomeRefsAndNulls()
        {
            ...
            nbhd.AddAcceptedPhasedVariant(
                new CalledAllele(AlleleCategory.Snv) { Chromosome = "chr1", Coordinate = 123, Reference = "A", Alternate = "T" , VariantQscore=35, AlleleSupport=10,TotalCoverage=50});
            ...
            var vcfVariant2asRef = new VcfVariant()
            {
                ...
                { new Dictionary<string, string>() {{"GT", "0/0"},{"DP", "1000"},{"AD", "844"} }},
            };
        ...
        public void CallAVariantInANewLocation()
        {
            ...
            var newMNV = new CalledAllele(AlleleCategory.Snv) { Chromosome = "chr1", Coordinate = 129, Reference = "A", Alternate = "TT" };
