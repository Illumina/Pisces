...
namespace VariantPhasing.Tests.Models
{
    public class VcfNeighborhoodTests
    {
        ...
        public void SortSites()
        {
            ...
            variantSite1.OriginalAlleleFromVcf = new Pisces.Domain.Models.Alleles.CalledAllele() { Coordinate = 7};
            ...
            variantSite2.OriginalAlleleFromVcf = new Pisces.Domain.Models.Alleles.CalledAllele() { Coordinate =8 };
            ...
            variantSite3.OriginalAlleleFromVcf = new Pisces.Domain.Models.Alleles.CalledAllele() { Coordinate = 9 };
            ...
            Assert.Equal(7, nbhd.VcfVariantSites[2].OriginalAlleleFromVcf.Coordinate);

            Assert.Equal(140453137, nbhd.VcfVariantSites[3].VcfReferencePosition);
            Assert.Equal(140453137, nbhd.VcfVariantSites[3].TrueFirstBaseOfDiff);
            Assert.Equal("C", nbhd.VcfVariantSites[3].VcfReferenceAllele);
            Assert.Equal("T", nbhd.VcfVariantSites[3].VcfAlternateAllele);
            Assert.Equal(8, nbhd.VcfVariantSites[3].OriginalAlleleFromVcf.Coordinate);
            ...
            Assert.Equal(9, nbhd.VcfVariantSites[4].OriginalAlleleFromVcf.Coordinate);
        }
        ...
        public void AddMnvsFromClusters()
        {
            ...
            var depths = nbhd.DepthAtSites(new List<ICluster>() { mockCluster.Object });
        ...
        public void GetOriginalVcfIndexes()
        {
            ...
            var originalVar1 = new Pisces.Domain.Models.Alleles.CalledAllele() { Coordinate = 1 };
            var originalVar10 = new Pisces.Domain.Models.Alleles.CalledAllele() { Coordinate = 10 };
            ...
            Assert.Equal(1, originalVcfIndexes[0].Coordinate);
            Assert.Equal(10, originalVcfIndexes[1].Coordinate);
        }
